...
.defines(function () {
    EntityPlayer = ig.Entity.extend({
        ...
        jumpFx: new ig.Sound('media/sound/fx/jump.*', false),
        ...
        ready: function() {
            ...
            ig.game.player = this;
            ig.game.numberOfGold = 8;
            ig.game.numberOfDeaths = 0;
            ig.game.playerRespawnX = this.pos.x;
            ig.game.playerRespawnY = this.pos.y;
        }
    });
});